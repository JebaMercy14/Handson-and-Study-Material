...
public class FutureTimedGetIndexer {
	...
	public static void main(String[] args) {
		...
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2000, "Nested Classes", "https://docs.oracle.com/javase/tutorial/java/javaOO/nested.html","httpz://docs.oracle.com"));
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2001,"Java SE Downloads", "https://www.oracle.com/technetwork/java/javase/downloads/index.html","http://www.oracle.com"));
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2002, "Interface vs Abstract Class", "https://mindprod.com/jgloss/interfacevsabstract.html", "http://mindprod.com"));
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2004, "Virtual Hosting and Tomcat", "https://tomcat.apache.org/tomcat-6.0-doc/virtual-hosting-howto.html", "http://tomcat.apache.org"));
